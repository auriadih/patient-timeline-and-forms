...
links.Timeline.Item = function (data, options) {
    if (data) {
        ...
        this.type = data.type;
        this.tooltip = data.tooltip; // TK added 2018-06-12
    }
    this.top = 0;
    this.left = 0;
    this.width = 0;
...
links.Timeline.ItemBox.prototype.createDOM = function () {
    ...
    // TODO: ability to add tooltips
    //console.log(divBox);
    //$(divBox).attr("rel", "tooltip").attr("data-original-title", "test");
...
links.Timeline.prototype.getGroup = function (groupName) {
    ...
    if (groupIndex == undefined && groupName != undefined) { // not null or undefined
        ...
        } else if (this.options.groupsOrder == "hard-code") {
          groups = groups.sort(function (a, b) {
            if (a.content == "Keskeinen" & b.content == "Kiinnostava") {
              return 1;
            }
            if (a.content == "Kiinnostava" & b.content == "Muu") {
              return 1;
            }
            if (a.content == "Keskeinen" & b.content == "Muu") {
              return 1;
            }
            if (a.content == "Kiinnostava" & b.content == "Keskeinen") {
              return -1;
            }
            if (a.content == "Muu" & b.content == "Keskeinen") {
              return -1;
            }
          })
        }
            ...
            if (this.groups.hasOwnProperty(groupName)) {
                ...
                while (i < iMax) {
                    ...
                    if (neighbors > maxItems) {
                        ...
                        //var title = 'Sisältää ' + count + ' tapahtumaa. Zoomaa lähemmäs nähdäksesi yksittäiset tapahtumat.';
                        var title = ''
